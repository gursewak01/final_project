...
class DeleteTutorialPage extends StatefulWidget {
  const DeleteTutorialPage({super.key});

  @override
  State<DeleteTutorialPage> createState() => _DeleteTutorialPageState();
}

class _DeleteTutorialPageState extends State<DeleteTutorialPage> {
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Center(
                                                                        child: ElevatedButton(
                                                                            ...
                                                                            style: ButtonStyle(backgroundColor: MaterialStatePropertyAll(Colors.red.shade400), foregroundColor: MaterialStatePropertyAll(Colors.white)),
                                                                            child: Text("Delete")),
                                                                      ),
                                                                    ],
                                                                  ),
